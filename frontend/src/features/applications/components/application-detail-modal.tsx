...
export const ApplicationDetailModal = memo(({ application, onClose }: ApplicationDetailModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div ref={modalRef} className="w-full max-w-3xl bg-white border border-neutral-200 rounded-xl sm:rounded-2xl shadow-elevated flex flex-col max-h-[90vh] overflow-hidden">
