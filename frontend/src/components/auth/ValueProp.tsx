...
export default function ValueProp() {
  return (
    <div className="hidden md:flex flex-col justify-between p-8 lg:p-12 bg-muted/50">
      <div className="space-y-4 lg:space-y-6">
        <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-lg bg-primary flex items-center justify-center text-primary-foreground shadow-sm">
        ...
        <ul className="space-y-3 lg:space-y-4">
          {BENEFITS.map((item, i) => (
            <li key={i} className="flex items-center gap-2 lg:gap-3 text-xs lg:text-sm text-muted-foreground">
